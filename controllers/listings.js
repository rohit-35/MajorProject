...
module.exports.createListing = async(req, res, next) => {
    ...
    fetch(`https://api.maptiler.com/geocoding/${encodeURIComponent(place)}.json?key=${key}`)
    .then(res => res.json())
    .then(data => {
...
module.exports.createListing = async (req, res, next) => {
    try {
        ...
        const response = await fetch(`https://api.maptiler.com/geocoding/${encodeURIComponent(place)}.json?key=${key}`);
